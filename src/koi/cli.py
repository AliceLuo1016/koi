...
_DEFAULT_AGENTS_MD = (
    ...
    "- When you spot repeated steps or errors, update "
    "the relevant skill(s) or memory with the more "
    "efficient path (use known working commands, "
    ...
    "preferences, environment quirks, project-wide "
    "patterns.\n\n"
